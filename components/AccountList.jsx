      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          ...
          <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg p-4">
            <p className="text-gray-700 text-sm font-medium">Total System Balance</p>
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-100 border-b-2 border-gray-300">
                <tr>
                  ...
                  <th className="px-4 py-3 text-left font-semibold text-gray-700">Holder Name</th>
                  <th className="px-4 py-3 text-right font-semibold text-gray-700">Balance</th>
                  <th className="px-4 py-3 text-center font-semibold text-gray-700">KYC Status</th>
                  <th className="px-4 py-3 text-center font-semibold text-gray-700">Created At</th>
                </tr>
              </thead>
              <tbody>
                {accounts.map((account, index) => (
                  <tr key={account.accountNo} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    <td className="px-4 py-3 text-gray-800 font-mono text-xs">{account.accountNo}</td>
                    <td className="px-4 py-3 text-gray-800">{account.holderName}</td>

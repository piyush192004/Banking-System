 ...
 * @returns {Object} {valid: boolean, error?: string}
 */
function validateAccountExists(accountNo, bankStore) {
 ...
 * @returns {Object} {valid: boolean, error?: string}
 */
function validateKYCVerification(account) {
 ...
 * @returns {Object} {valid: boolean, error?: string}
 */
function validateDifferentAccounts(senderAccountNo, receiverAccountNo) {
